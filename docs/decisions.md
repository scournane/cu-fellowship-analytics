...
## ADR-033 — One Slack stack, two halves, one event store
...
## ADR-034 — The attention index is a triage order, not a score
...
## ADR-035 — Badges are private, opt-out, and ranked by giving
